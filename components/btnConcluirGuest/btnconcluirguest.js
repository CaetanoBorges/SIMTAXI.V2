const debliwui_btnconcluirguest = document.createElement('template');
debliwui_btnconcluirguest.innerHTML = `
    <style>
        .container{
            position:relative;
            display:block;
    ...
    <div class="container">
        <button class="btn">CONCLUIR ARRENDAMENTO</button>
        <div class="backdrop"></div>
        <div class="content">
            <p>Tem certeza?</p>
            <button class="dois">SIM, QUERO ARRENDAR</button>
        </div>
    </div>
`;

class debliwuibtnconcluirguest extends HTMLElement {

    constructor() {
        super();
        this.attachShadow({ mode: 'open' });
        this.shadowRoot.appendChild(debliwui_btnconcluirguest.content.cloneNode(true));
    }
    fechar() {
...
window.customElements.define('debliwui-btnconcluirguest', debliwuibtnconcluirguest)