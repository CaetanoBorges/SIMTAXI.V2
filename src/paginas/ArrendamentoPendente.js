...
<style>
    ...
    .taxiacaminho p { font-size:clamp(13px,4vw,16px);line-height:1.6;text-align:center;color:#111;margin:0; }
    .taxiacaminho > div {
        display:flex;gap:12px;margin-top:8px;width:min(100%,300px);
    }
    .taxiacaminho > div a {
    ...
    #ligar-rent { background:rgba(231,76,60,0.70);border:1px solid rgba(231,76,60,0.5);color:#fff; }
    .btn-esperar { background:rgba(74,144,217,0.70);border:1px solid rgba(74,144,217,0.5);color:#fff; }
</style>
