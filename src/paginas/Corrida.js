...
<div class="corrida">
    ...
    <div id="detalhes"></div>
    <div id="butoes">
        <debliwui-btnmotorista></debliwui-btnmotorista>
    </div>
    <div class="cancelada">
...
<style>
    ...
    .actions {
        ...
        position:fixed;bottom:0;left:0;padding:10px 3%;
  ...
  function init() {
    if (window._corrida && window._corrida.verCorrida) {
      window._corrida.verCorrida();
    }
